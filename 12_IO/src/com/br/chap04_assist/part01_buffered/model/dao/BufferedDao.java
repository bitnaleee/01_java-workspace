...
public class BufferedDao {
	 ...
	 *             
	 * BufferedXXXXX : 속도를 향상 시킨다거나 기반스트림에서 제공하지 않는 메소드들을 제공
	 * 
	 */
	...
	public void fileSave() {
		...
		try {
			...
			// 버퍼라는 공감에 계속 쌓아놨다가 한번에 출력해줌 => 속도향상에 도움줌
			bw.write("안녕하세요\n");
			bw.write("반갑습니다.");
			bw.newLine(); // 추가적인 메소드 제공
			bw.write("저리가세요.");
	...
	public void fileRead() {
		...
		try(BufferedReader br = new BufferedReader(new FileReader("c_buffer.txt"))) {
			...
			// readLine() : 한줄씩 읽어들이는 메소드 (기반스트림x 보조스트림o)
			/*
