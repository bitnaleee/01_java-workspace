...
public class B_Switch {
	 ...
	 *     단, switch문은 동등비교만 가능 (동등 비교할 값들만 작성)
	 ...
	 *   case 값2 : 실행코드2;
	 *   ...
	 *   default : 위의 값들과 모두 일치하지 않을 경우 실행할 코드; 대부분 마지막이라 break 써도되고 안써도 되고 
	 *   } 
	 */
	...
	public void method5() {
		...
		switch(month) {
		case 1 : case 3 : case 5 : case 7 : case 8 : case 10 : case 13 : System.out.println("입력하신 월은 31일까지입니다."); break;
		case 4 : case 6 : case 9 : case 11 : System.out.println("입력하신 월은 30일까지입니다."); break;
	    case 2 : System.out.println("입력하신 월은 28일 또는 29일까지입니다."); break;
		default : System.out.println("반드시 1~12월까지를 입력해야됩니다.");
		}
	}
