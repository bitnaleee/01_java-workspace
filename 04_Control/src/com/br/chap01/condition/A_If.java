...
public class A_If {
	 ...
	 *		  "    false일 경우 => 중괄호 블럭안의 코드 무시하고 넘어감 
	 * 
	 */
	...
	public void method4() {
		...
		*/
		...
		if(num == 0) {
			...
			System.out.println("입력한 숫자는 짝수입니다."); // 첫번째 조건이랑 겹쳐서 실행될 일이 없음 순서 중요!
		}
	...
	public void method6() {
		...
		*/
		...
		String result = ""; // 반드시 변수 세팅시 빈 문자열이라도 초기화를 해두는 습관을 가지자!
	...
	public void method7() {
		...
		// 사용자에게 점수를 입력받은 후
		// 점수가 0점이상 100점이하인지(적절한 범위) 아닌지를 판별 한 후
		...
		// else { grade = "F";} 할 수도 있다
		// 초기화할 때 "F" 넣을 수 있다 그리고 마지막 줄 생략
		...
		// -50 입력했을때 -50점은 F등급입니다. 라고 뜸 > 이중if로 해결
	...
	public void method8() {
		...
		*/
		// 홍길동님이 아니신가보네요. 안녕히가세요.라고 출력되는 이유 
		/*
		 * 				1		1	  2		4		8	 4		8	   2
		...
		if(name.equals("홍길동")) { // ("홍길동".equals(name)) 가능
			System.out.println("홍길동님 반갑습니다.");
		} else {
			System.out.println("홍길동님이 아니신가보네요. 안녕히가세요.");
		}
	...
	public void method9() {
		...
		if (num > 0) { // 양수일 경우
			...
			if (num % 3 == 0) { // (양수이고) 3으로 나눠떨어지는 경우 == 3의 배수
