...
public class A_Variable {
	...
	public void declareVariable() {
		 ...
		 * 	[표현법] 자료형 변수명;
		 *
		 *	자료형 : 어떤 값을 담아낼지, 어떤 크기의 값을 담아낼지에 대해 변수(박스)의 크기 및 모양을 정하는 것
		...
		boolean bool2 = 1 + 3 < 2; // 대소비교연산값 대입
	 ...
	 * 			(final을 붙여서 선언 / 상수명은 다 대문자로 하는걸 권장)
	 */
