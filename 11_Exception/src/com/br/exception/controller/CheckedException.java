...
public class CheckedException {
	...
	public void method2() throws IOException {
		...
		*/
		...
		// 2. throws : 지금 즉시 예외를 처리하지 않고 현재 이 메소드를 호출했던 곳(method1)으로 예외처리를 떠넘기겠다(위임하다)
			String str = br.readLine();
			System.out.println(str);
			
			System.out.println("프로그램을 종료합니다.");
		
			// main까지 쭉 throws로 떠넘기면 JVM이 알아서 처리 (권장하지않음)
			
	}
	
	/*
	 * 							예외 클래스			예외발생시점				예외처리
	 * UncheckedException	RuntimeException관련	 런타임에러(프로그램실행시)	세모(개발자가 케바케로 처리 => 조건문 / 예외처리)
