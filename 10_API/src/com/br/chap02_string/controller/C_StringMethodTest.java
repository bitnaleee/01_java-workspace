...
public class C_StringMethodTest {
	...
	public void method() {
		...
		String str3 = str1 + "!!!";
		System.out.println("str3 : " + str3); // str3 : Hello World!!! 위랑 똑같음 그러나 
		
		System.out.println("str2와 str3가 일치합니까(==) : " + (str2 == str3)); // false (주소값)
		...
		System.out.println("str1에 Hell문자열이 포함되어있습니까 : " + str1.contains("Hell")); // true
		...
		System.out.println(str1.substring(0,4)); // Hell
		...
		System.out.println("str4 : " + str4); // str4 : Hecco Worcd
		System.out.println("str1이 변경됐나 : " + str1); // str1이 변경됐나 : Hello World
		
		// 8. 문자열.toUpperCase() : String => 문자열을 다 대문자로 변경한 새문자열 리턴
		//    문자열.toLowerCase() : String =>	"	   소문자로		"
		String str5 = str1.toUpperCase();
		System.out.println("str5 : " + str5); // str5 : HELLO WORLD
