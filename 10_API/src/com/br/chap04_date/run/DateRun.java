...
public class DateRun {
	...
	public static void main(String[] args) {
		...
		// 기본생성자를 이용해서 생성
		Date date1 = new Date();
		System.out.println(date1); // Wed May 17 16:08:32 KST 2023
		
		// 내가 원하는 날짜(2023년 03월 27일)로 셋팅
		// 1) 매개변수 생성자를 이용해서 생성
		Date date2 = new Date(2023-1900, 3-1, 27);
		System.out.println(date2); // Mon Mar 27 00:00:00 KST 2023
		...
		System.out.println(date1); // Mon Mar 27 16:08:32 KST 2023
		...
		System.out.println(formatDate); // 2023년 03월 27일(월) 16시 08분 32초
