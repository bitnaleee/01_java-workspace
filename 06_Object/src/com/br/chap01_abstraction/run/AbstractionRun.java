...
public class AbstractionRun {
	...
	/*
	 * 1. 객체지향언어 : "객체"를 "지향"하는 언어 (객체중심으로 돌아감)
	 * 2. 객체란?
	 * 	  사전적정의 : 현실세계에 독립적으로 존재하는 모든 것들
	 ...
	 *		2) 객체들이 가지고 있는 공통적인 속성, 기능들을 모두 추출할 것
	 ...
	 * 			2) 공통적인 속성 및 기능들(이름, 나이, 주소, 전화번호, 키, 몸무게, 달리기속도, 학년, 반, 국어점수, 수학점수, 머리색깔, 발사이즈, 먹는다, 똥산다, 잠잔다, ...)
	 ...
	 * 				...
	 * 
	 * 				어떤 문제? => 수백명의 학생객체들을 만들고자 할 때 수천개의 변수가 만들어짐
	 * 
	 * 			2) "배열"만으로 프로그래밍을 한다면??
	 * 				배열 - 하나의 자료형의 여러개의 값들을 보관
	 * 				
	 * 				학생들의 이름 String[] name = {"홍길동, "김말똥", "강아쥐", ...}
	 * 				학생들의 나이    int[] age  = {  20 ,    21  ,   22  ,  ...}
	 *              학생들의 키  double[] height = {162.3, 173.4, 182.7, ...}
	 * 				
	 * 				어떤 문제? => 기존의 학생 정보를 지울 때 잘못 지우면 값이 변질될 수 있음
